...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "AI-verified work logs, real-time kanban, and tamper-proof audit trail. Built for managers who refuse to fly blind." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Taskora — Verified accountability for every team" },
      { name: "twitter:description", content: "AI-verified work logs, real-time kanban, and tamper-proof audit trail. Built for managers who refuse to fly blind." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/4423f27e-a6c4-4dc8-af96-e3378c1433ed/id-preview-7c5427de--d97ab544-5e06-4a37-aaf1-189305a35974.lovable.app-1780129112543.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/4423f27e-a6c4-4dc8-af96-e3378c1433ed/id-preview-7c5427de--d97ab544-5e06-4a37-aaf1-189305a35974.lovable.app-1780129112543.png" },
    ],
    links: [
